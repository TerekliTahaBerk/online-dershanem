          ...
          <div className="bg-[#091413] text-white p-10 sm:p-14 flex flex-col justify-between">
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl font-semibold leading-tight text-white">
                Takibini buradan<br />
                <span className="text-emerald-400">sürdür.</span>
              </h1>
              <p className="mt-4 text-stone-400 text-sm leading-relaxed max-w-xs">
                Ders takviminizi, öğretmen notlarını ve ödeme geçmişinizi tek panelden görün.
              </p>
            </div>

            <div className="mt-12 grid grid-cols-2 gap-3">
              {[
                { icon: CalendarDays, label: "Ders takvimi", desc: "Haftalık planınız" },
                { icon: BookOpen, label: "Ders bağlantısı", desc: "Saatinde katılın" },
                { icon: CreditCard, label: "Ödemeler", desc: "İşlem durumunuz" },
          ...
          <div className="bg-white p-8 sm:p-10 flex flex-col justify-center">
            <div className="mb-8">
              ...
              <p className="mt-1.5 text-sm text-stone-500">
                Öğrenci, öğretmen ve yönetici hesapları bu ekranı kullanır.
              </p>
            </div>
