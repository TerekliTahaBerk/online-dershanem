        ...
        <div className="px-4">
          {isSuccess ? (
            <CheckoutResultCard
              ...
              nextStepNote={
                <>
                  <strong>Sıradaki adım:</strong> E-posta adresinizle
                  oluşturulan öğrenci hesabına giriş yaparak paketinizdeki
                  denemeleri görebilirsiniz.
                </>
              }
              primaryAction={{
            ...
            <CheckoutResultCard
              ...
              primaryAction={{
                href: `/odk-paketleri/${slug}/satin-al/sonuc?status=success&orderId=${orderId}`,
                label: "Durumu Yenile",
                variant: "primary",
              }}
