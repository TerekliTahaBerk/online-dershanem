        ...
        data={{
          ...
          plan: {
            ...
            steps: [
              {
                label: "Hafta 1–2",
                text: "Seviye tespiti ve temel eksik kapatma: sayılar, oran-orantı.",
              },
              {
                label: "Hafta 3–4",
                text: "Cebirsel ifadeler ve denklemler; yeni nesil soruya giriş.",
              },
              {
                label: "Hafta 5–6",
                text: "Geometri temelleri, veri ve olasılık.",
              },
              {
                label: "Hafta 7–8",
                text: "Karışık deneme çözümü, hız ve süre yönetimi.",
              },
            ],
          },
          sampleSummary: {
            ...
            rows: [
              ...
              {
                label: "Zorlandığı yer",
                value: "Benzerlik oranını kurarken kenar eşleştirmesi",
              },
              {
                label: "Bu hafta ödevi",
                value: "10 yeni nesil soru + 1 deneme bölümü",
              },
              {
                label: "Sonraki hedef",
                value: "Çokgenler ve alan problemleri",
              },
            ],
          },
          resources: [
            ...
            {
              label: "Matematik deneme analizi",
