        ...
        <form action={createStudentAction} className="space-y-6">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
              <span className="w-5 h-5 rounded-full bg-[#408A71] text-white text-xs flex items-center justify-center font-bold">1</span>
              Temel Bilgiler
            </h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
              <span className="w-5 h-5 rounded-full bg-[#408A71] text-white text-xs flex items-center justify-center font-bold">2</span>
              Akademik Bilgiler
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
              <span className="w-5 h-5 rounded-full bg-[#408A71] text-white text-xs flex items-center justify-center font-bold">3</span>
