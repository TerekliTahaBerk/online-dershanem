...
export default async function EducationAdminPage() {
  ...
  const [teachersRaw, studentsRaw, parentsRaw, groupsRaw, lessons, assignments, materials] = await Promise.all([
