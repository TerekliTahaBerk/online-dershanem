...
export default async function TeacherDigestsPage() {
    ...
    include: {
      ...
      weeklyDigests: {
        where: {
          weekStart: {
            gte: weekStart,
            lt: addIstanbulCalendarDays(weekStart, 7),
          },
        },
  ...
  return (
    ...
    >
      ...
      <div className="mt-7">
        <TeacherDigestReview
          initialRows={students.map((student) => {
            const digest = student.weeklyDigests[0];
            return {
