...
export default function TYTLandingPage() {
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqJsonLd(yksFaq)) }}
      />
      <ExamSalesLanding
        data={{
          examKey: "YKS",
          ...
          plan: {
            ...
            steps: [
              {
                label: "1. blok",
                text: "Konu anlatımı ve birlikte çözüm (canlı ders).",
              },
              {
                label: "2. blok",
                text: "TYT hız çalışması: temel soru tipleri ve süre.",
              },
              {
                label: "3. blok",
                text: "AYT derinlik: seçili konuda zor soru pratiği.",
              },
              {
                label: "4. blok",
                text: "Deneme analizi ve sonraki hafta planı.",
              },
            ],
          },
          sampleSummary: {
            ...
            rows: [
              {
                label: "İşlenen konu",
                value: "Türev — artan/azalan ve ekstremum",
              },
              { label: "Zorlandığı yer", value: "İşaret tablosunu yorumlama" },
              {
                label: "Bu hafta ödevi",
                value: "AYT seçmeli 15 soru + 1 TYT deneme bölümü",
              },
