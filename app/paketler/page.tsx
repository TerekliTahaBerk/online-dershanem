        ...
        <Container>
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-[1fr_320px]">
                ...
                <section key={group.key} className="space-y-4">
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    {group.packages.map((pkg, index) => (
                      <FadeIn key={`${group.key}-${pkg.subject}`} delay={index * 0.06}>
                        <article className="rounded-3xl border border-line bg-white p-6 shadow-soft transition duration-300 hover:-translate-y-1 hover:shadow-lg">
                          <div className="flex items-start justify-between gap-3">
                            ...
                            {pkg.badge ? (
                              <span className="rounded-full bg-mint px-3 py-1 text-[11px] font-semibold text-pine">{pkg.badge}</span>
                            ) : null}
                          </div>
                          ...
                          <PurchaseFunnelTrigger
                            ...
                            className="mt-5 inline-flex w-full items-center justify-center rounded-full bg-anchor px-5 py-2.5 text-xs font-semibold text-white transition duration-300 hover:-translate-y-0.5 hover:bg-pine"
            ...
            <div className="space-y-4 lg:sticky lg:top-24 lg:self-start">
              <FadeIn>
                <div className="rounded-3xl border border-line bg-white p-5 shadow-soft transition duration-300 hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <div className="mt-4 flex flex-col gap-2">
                    <ContactLink
                      ...
                      className="inline-flex items-center justify-center rounded-xl bg-anchor px-4 py-2 text-xs font-semibold text-white transition duration-300 hover:-translate-y-0.5 hover:bg-pine"
                    >
