      ...
      <main id="main-content" tabIndex={-1}>
        <section className="site-container flex justify-center py-16 sm:py-24">
          <div className="w-full max-w-[440px]">
            ...
            <h1 className="mt-5 font-display text-[clamp(2rem,4vw,2.6rem)] leading-[1.1] text-[var(--site-ink)]">
              Parolanızı yenileyin.
            </h1>
            <p className="mt-3 text-[15px] leading-7 text-[var(--site-body)]">
              Hesabınızda kullandığınız e-postayı yazın. Kayıtlıysa size güvenli
              bir yenileme bağlantısı göndereceğiz.
            </p>
