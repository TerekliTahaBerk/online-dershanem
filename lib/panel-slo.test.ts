...
test("SLO raporu p90 ve başarı oranlarını hesaplar", () => {
  const rows = [
    ...
    ...Array.from({ length: 5 }, () => row("plan_generated", { ruleVersion: "adaptive-v2", taskCount: 6, capacityMinutes: 135, reasonCount: 3, rebalanced: false })),
    ...
    ...Array.from({ length: 5 }, () => row("case_rule_triggered", { ruleVersion: "intervention-v3", reasonCode: "REPEATED_REVIEW_DIFFICULTY" })),
