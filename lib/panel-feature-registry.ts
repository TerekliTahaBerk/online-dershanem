...
export const panelFeatureRegistry: readonly PanelFeatureDefinition[] = [
  ...
  { key: "dinoAi", label: "Dino AI özetleri", status: "experimental", owner: "AI Güvenliği ve Ürün", roles: ["STUDENT", "PARENT", "TEACHER"], dataDependency: "0085_dino_answers; Gemini sağlayıcı + dış aktarım onayı + maliyet oranları", e2eCoverage: "dino unit: izin listesi, atıf doğrulama, rol kapsamı", rollback: "Önce DINO_PROVIDER=fallback (dışarı istek durur), sonra PANEL_FEATURE_DINO_AI=false", legacyPublicEnvironmentKey: null },] as const;
