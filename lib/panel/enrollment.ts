...
import {
  ...
  type PaymentPlanPreviewItem,
} from "@/lib/panel/enrollment-shared";

// Re-export shared API so existing call sites keep working.
export {
  calculatePaymentPlanPreview,
  getEnrollmentStatusLabel,
  getEnrollmentStatusTone,
...
// ─────────────────────────────────────────────────────────────────────────────
// Status display helpers — re-exported from `enrollment-shared.ts`.
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Plan preview (pure) — implementations live in `enrollment-shared.ts`.
// `addMonths` and `startOfToday` are used by other functions below.
// ─────────────────────────────────────────────────────────────────────────────
