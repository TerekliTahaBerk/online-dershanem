...
export function CartFab() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-5 right-5 z-50 group flex items-center gap-3 rounded-full bg-[#091413] pl-4 pr-5 py-3 text-white shadow-2xl shadow-black/30 hover:bg-black transition-all"
    >
