    ...
    <section id="paketler" className="scroll-mt-24 bg-white">
      <div className="site-container site-section">
        <div className="mx-auto max-w-3xl text-center">
          <p className="site-kicker">LGS ve YKS paketleri</p>
          <h2 className="mt-4 text-[clamp(2.4rem,6vw,4rem)] font-semibold leading-[1.02] tracking-[-.045em] text-[var(--site-ink)]">Özel ders kadar yakın. Dershane kadar erişilebilir.</h2>
