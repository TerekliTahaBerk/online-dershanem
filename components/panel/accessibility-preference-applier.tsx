...
const attributes = [
  "data-panel-motion",
  "data-panel-contrast",
  "data-panel-text-scale",
  "data-panel-spacing",
] as const;

export function applyAccessibilityViewPreference(
  preference: AccessibilityViewPreference,
) {
  ...
  root.dataset.panelTextScale =
    preference.textScale === "LARGE" ? "large" : "default";
  root.dataset.panelSpacing = preference.comfortableSpacing
    ? "comfortable"
    : "default";
}

export function AccessibilityPreferenceApplier({
  preference,
}: {
  preference: AccessibilityViewPreference;
}) {
