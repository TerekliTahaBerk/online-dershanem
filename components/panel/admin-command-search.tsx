...
const commands = [
  ...
  { label: "Öğrencileri aç", detail: "Öğrenci hesaplarını ve grup durumunu gör", href: "/panel/yonetim/ogrenciler", icon: UsersRound },
  { label: "Kişileri aç", detail: "Öğrenci, öğretmen, veli ve yönetici hesapları", href: "/panel/yonetim/kullanicilar", icon: UsersRound },
