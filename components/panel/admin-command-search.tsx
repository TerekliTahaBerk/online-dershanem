...
const commands: CommandItem[] = [
  ...
  { label: "Eğitmenleri aç", detail: "Eğitmen operasyon görünümünü aç", href: "/panel/yonetim/egitmenler", icon: UsersRound },
  { label: "Velileri aç", detail: "Veli operasyon görünümünü aç", href: "/panel/yonetim/veliler", icon: UsersRound },
  { label: "Kişileri aç", detail: "Evrensel dizin: tüm rollerde arama", href: "/panel/yonetim/kullanicilar", icon: UsersRound },
