...
const SESSION_DATE_FORMATTER = new Intl.DateTimeFormat("tr-TR", {
  dateStyle: "medium",
  timeStyle: "short",
});
            ...
            <div className="flex min-w-0 gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-xs text-[var(--site-muted)]">
                  ...
                  En geç:{" "}
                  {SESSION_DATE_FORMATTER.format(new Date(session.expiresAt))}
                </p>
              </div>
            </div>
            {!session.current ? (
              <button
                ...
                className="mt-3 inline-flex items-center gap-2 text-sm font-bold text-rose-700 sm:mt-0"
              >
                {pending === session.id ? (
