 ...
 * - `connect-src`: NextAuth, Vercel Analytics, Pusher, Upstash (cache), Vercel Blob.
 * - `img-src` / `media-src`: data + blob (avatar/PDF render), Vercel Blob CDN.
 */
const csp = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://vercel.live https://www.googletagmanager.com https://js.pusher.com",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "font-src 'self' https://fonts.gstatic.com data:",
  "img-src 'self' data: blob: https: http:",
  "media-src 'self' blob: data:",
  "connect-src 'self' https://*.vercel-insights.com https://vitals.vercel-insights.com https://*.pusher.com wss://*.pusher.com https://*.upstash.io https://*.public.blob.vercel-storage.com https://api.resend.com https://www.google-analytics.com",
